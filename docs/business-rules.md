...
26. Chi phí có `accountingTreatment=inventory_cost` được đưa vào giá vốn hàng tồn kho và không được trừ lần nữa như chi phí vận hành khi tính lợi nhuận. Khoản chưa thanh toán vẫn là chi phí/công nợ phát sinh nhưng chỉ làm giảm số dư tiền doanh nghiệp sau khi chuyển sang `paid`.

...
15. Tiền còn lại của doanh nghiệp để claim được tính bằng tổng doanh thu thực nhận trừ tổng tiền nhập hàng có nguồn `Tiền bán hàng`. Chỉ phiếu nhập đang dùng `Vốn chủ` và có nguyên giá nhỏ hơn số tiền còn lại mới được chọn; tổng nhiều phiếu được chọn cũng phải nhỏ hơn số tiền còn lại. Khi claim, hệ thống ghi snapshot thoái vốn và đổi nguồn tiền của phiếu nhập sang `Tiền bán hàng`; khi xóa claim, nguồn tiền được hoàn lại thành `Vốn chủ`.
